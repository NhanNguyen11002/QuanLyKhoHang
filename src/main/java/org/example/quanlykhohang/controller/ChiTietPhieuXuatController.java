...
public class ChiTietPhieuXuatController {
    ...
    public void initData(PhieuXuat phieuXuat){
        ...
        khachHangLbl.setText(phieuXuat.getDonXuatHang().getKhachHang().getTenKhachHang());
    ...
    private void onXuatPDFBtnClick(){
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                ...
                contentStream.showText("CHI TIẾT PHIẾU XUẤT");
                ...
                ObservableList<ChiTietDonXuatHang> dataList = ctPhieuXuatTbl.getItems();
